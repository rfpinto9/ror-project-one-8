...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { age: @director.age, name: @director.name, oscars: @director.oscars } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { age: @director.age, name: @director.name, oscars: @director.oscars } }
